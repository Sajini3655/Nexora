...
export default function App() {
  return (
    <Routes>
      ...
      {/* Chat Permission */}
      <Route element={<ProtectedRoute moduleKey="CHAT" />}>
        <Route path="/manager/chat" element={<ManagerShell><div>Manager Chat Page</div></ManagerShell>} />
      </Route>

      {/* Files Permission */}
      <Route element={<ProtectedRoute moduleKey="FILES" />}>
        <Route path="/manager/files" element={<ManagerShell><div>Manager Files Page</div></ManagerShell>} />
      </Route>

      {/* Reports Permission */}
      <Route element={<ProtectedRoute moduleKey="REPORTS" />}>
        <Route path="/manager/reports" element={<ManagerShell><div>Manager Reports Page</div></ManagerShell>} />
      </Route>
