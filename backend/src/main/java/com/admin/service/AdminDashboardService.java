...
public class AdminDashboardService {
    ...
    public AdminDashboardStatsResponse getStats() {
        ...
        try { admins = userRepository.countByRole(Role.ADMIN); } catch (Exception e) { e.printStackTrace(); }
        try { managers = userRepository.countByRole(Role.MANAGER); } catch (Exception e) { e.printStackTrace(); }
        try { developers = userRepository.countByRole(Role.DEVELOPER); } catch (Exception e) { e.printStackTrace(); }
        try { clients = userRepository.countByRole(Role.CLIENT); } catch (Exception e) { e.printStackTrace(); }
