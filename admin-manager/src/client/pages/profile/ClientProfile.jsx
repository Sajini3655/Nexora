  ...
  const handleSave = async () => {
    try {
      ...
      if (selectedFile) {
        ...
        formData.profilePicture = updatedProfilePicture;
  ...
  return (
    <ClientLayout>
      <Box sx={{ maxWidth: 900, mx: "auto" }}>
        ...
        >
          <CardContent>
            <Typography variant="h6" sx={{ fontWeight: 800, mb: 3, fontSize: 15 }}>
              Profile Picture
            </Typography>
              ...
              <Box>
                <Avatar
                  ...
                  sx={{
                    ...
                    background: "linear-gradient(135deg, rgba(124,92,255,0.2), rgba(0,255,170,0.1))"
                  }}
                >
                ...
                <Grid item xs={12}>
                  <Stack direction="row" spacing={2} sx={{ pt: 2 }}>
                    <Button
                      ...
                      disabled={saving}
                      sx={{
                        background: "linear-gradient(135deg, rgba(124,92,255,0.9), rgba(124,92,255,0.7))",
                        textTransform: "none",
                        fontWeight: 700,
                        "&:hover": {
                          background: "linear-gradient(135deg, rgba(124,92,255,1), rgba(124,92,255,0.85))"
                        },
                        "&:disabled": {
